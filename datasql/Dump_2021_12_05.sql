...
INSERT INTO `user_activities` VALUES ('@billfashion','2021-04-27',623),('@billfashion','2021-04-27',178087),('@chillisauce','2021-04-27',623),('@chillisauce','2021-04-27',178087),('@chillisauce','2021-04-27',327659),('@chillisauce','2021-04-28',300597),('@donaldtrump','2021-04-27',327659),('@nhattan','2021-04-28',300597),('@nhattan','2021-04-29',178087),('@nhattan','2021-04-29',208971),('@nhattan','2021-04-29',230276),('@nhattan','2021-04-29',300597),('@nhattan','2021-04-29',327659);
...
CREATE TABLE `user_contacts` (
  ...
  PRIMARY KEY (`email`),
  KEY `userID` (`userID`),
  CONSTRAINT `user_contacts_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `user_authen` (`userID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'wherethefourcasting'
--

--
-- Dumping routines for database 'wherethefourcasting'
--
...
-- Dump completed on 2021-05-12  0:50:47
